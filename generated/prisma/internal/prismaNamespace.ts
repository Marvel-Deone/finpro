...
export type TypeMap<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> = {
  ...
  meta: {
    modelProps: "user" | "org" | "category" | "exam" | "stock" | "loan" | "history"
...
export const CategoryScalarFieldEnum = {
  id: 'id',
  name: 'name',
  seat_throughput: 'seat_throughput',
  project_inflow: 'project_inflow',
  iventory: 'iventory',
  monthly_dept: 'monthly_dept',
...
export const StockScalarFieldEnum = {
  ...
  operational_narrative: 'operational_narrative',
  count: 'count',
...
export const LoanScalarFieldEnum = {
  ...
  category: 'category',
  term: 'term',
  liability_proof: 'liability_proof',
  createdAt: 'createdAt',
  orgId: 'orgId'
} as const
